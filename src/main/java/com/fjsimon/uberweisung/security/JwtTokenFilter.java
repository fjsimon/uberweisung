package com.fjsimon.uberweisung.security;
...
public class JwtTokenFilter extends GenericFilterBean {
    ...
    private TransferreUserDetailsService userDetailsService;

    public JwtTokenFilter(TransferreUserDetailsService userDetailsService) {
